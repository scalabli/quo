...
class TextObject:
    ...
    def cut(self, buffer: Buffer) -> Tuple[Document, Data]:
        """
        Turn text object into `Data` instance.
        """
        from_, to = self.operator_range(buffer.document)
...
def load_vi_bindings() -> KeyBindingsBase:
    ...
    def _change_current_line(event: E) -> None:  # TODO: implement 'arg'
        ...
        data = Data(buffer.document.current_line, SelectionType.LINES)
    ...
    def _delete_line(event: E) -> None:
        ...
        # Set clipboard data
        event.app.clipboard.set_data(Data(deleted, SelectionType.LINES))
    ...
    def _yank_line(event: E) -> None:
        ...
        event.app.clipboard.set_data(Data(text, SelectionType.LINES))
    ...
    def _stop_macro(event: E) -> None:
        ...
        if vi_state.recording_register:
            vi_state.named_registers[vi_state.recording_register] = Data(
                vi_state.current_recording
            )
