from typing import TYPE_CHECKING, Any, Callable, Iterable, List, Tuple, Union, cast, Dict, Optional, NamedTuple
...
if TYPE_CHECKING:  # pragma: no cover
    from ..terminal import Terminal, ConsoleOptions, JustifyMethod, OverflowMethod
