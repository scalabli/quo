...
class CliRunner:
    """The CLI runner provides functionality to invoke a quo command line
    ...
    def isolation(self, input=None, env=None, color=False):
        ...
        This also rebinds some internals in quo to be mocked (like the
        ...
        old_forced_width = layout.FORCED_WIDTH
        layout.FORCED_WIDTH = 80
    ...
    def invoke(
        ...
        **extra,
        ...
        arguments are passed to the :meth:`~quopkg.Command.main` function of
        the command.
