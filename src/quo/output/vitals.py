...
from quo.input.vitals import prompt, _build_prompt
...
"""
    ...
    :param show_choices: Show or hide choices if the passed type is
    """
#    result = None
...
#        except (KeyboardInterrupt, EOFError):
            # getpass doesn't print a nl if the user aborts input with ^C.
...
def progressbar(
    ...
    a nl is printed and the progress bar is finalized on screen.
...
def style(
  ...
  Supported color names:
    ...
    * ``reset`` (reset the color code only)
    ...
    :param fg: if provided this will become the fg color.
...
def edit(
    ...
    Note for Windows: to simplify cross-platform usage, the nls are
