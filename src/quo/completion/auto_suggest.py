...
class AutoSuggest(metaclass=abc.ABCMeta):
    """
    ...
    def get_suggestion(
    ...
    ) -> t.Optional[Suggestion]:
        """
        Return `None` or a :class:`.Suggestion` instance.

        We receive both :class:`~quo.buffer.Buffer` and
        :class:`~quo.document.Document`. The reason is that auto
        ...
        :param buffer: The :class:`quo.buffer.Buffer` instance.
        :param document: The :class:`quo.document.Document` instance.
        """
...
class ThreadedAutoSuggest(AutoSuggest):
    ...
    async def get_suggestion_async(
        ...
        def run_get_suggestion_thread() -> t.Optional[Suggestion]:
            return self.get_suggestion(buff, document)
...
class ConditionalAutoSuggest(AutoSuggest):
    ...
    def __init__(self, auto_suggest: AutoSuggest, filter: t.Union[bool, Filter]) -> None:
...
class DynamicAutoSuggest(AutoSuggest):
    ...
    def __init__(self, get_auto_suggest: t.Callable[[], t.Optional[AutoSuggest]]) -> None:
