...
class Table(JupyterMixin):
    ...
    Args:
        *headers (Union[Column, str]): Column headers, either as a string, or :class:`~quo.tabulate.Column` instance.
    ...
    def get_row_style(self, console: "Terminal", index: int) -> StyleType:
    ...
    def _get_cells(
        self, console: "Terminal", column_index: int, column: Column
    ) -> Iterable[_Cell]:
    ...
    def _render(
        self, console: "Terminal", options: "ConsoleOptions", widths: List[int]
    ) -> "RenderResult":
