...
tabular_formats = list(sorted(_table_formats.keys()))
...
def simple_separated_format(separator):
    ...
    >>> tsv = simple_separated_format("\\t") ; \
        tabular([["foo", 1], ["spam", 23]], theme=tsv) == 'foo \\t 1\\nspam\\t23'
    True
...
def _format(val, valtype, floatfmt, missingval="", has_invisible=True):
    ...
    >>> hrow = ['\u0431\u0443\u043a\u0432\u0430', '\u0446\u0438\u0444\u0440\u0430'] ; \
        ...
        tabular(tbl, headers=hrow) == good_result
    True
    ...
    * pandas.DataFrame (usually used with headers="keys")
    ...
    if hasattr(tabular_data, "keys") and hasattr(tabular_data, "values"):
        ...
        if headers == "keys" and not rows:
            ...
            # print tabular(cursor, headers='keys')
...
def tabular(
    ...
    >>> echo(tabular([["F",24],["M",19]], showindex="always"))
    -  -  --
    0  F  24
    1  M  19
    -  -  --
    ...
    Various plain-text table formats (`theme`) are supported:
    'plain', 'simple', 'grid', 'pipe', 'orgtbl', 'rst', 'mediawiki',
    'latex', 'latex_raw', 'latex_booktabs', 'latex_longtable' and tsv.
    Variable `tabular_formats`contains the list of currently supported formats.

    "plain" format doesn't use any pseudographics to draw tables,
    it separates columns with a double space:

    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]],
    ...                 ["strings", "numbers"], "plain"))
    strings      numbers
    spam         41.9999
    eggs        451

    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="plain"))
    spam   41.9999
    eggs  451
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="simple"))
    ----  --------
    spam   41.9999
    eggs  451
    ----  --------
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="grid"))
    +------+----------+
    | spam |  41.9999 |
    +------+----------+
    | eggs | 451      |
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="pipe"))
    |:-----|---------:|
    | spam |  41.9999 |
    | eggs | 451      |
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="orgtbl"))
    | spam |  41.9999 |
    | eggs | 451      |
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="rst"))
    ====  ========
    spam   41.9999
    eggs  451
    ====  ========
    ...
    >>> echo(tabular([["strings", "numbers"], ["spam", 41.9999], ["eggs", "451.0"]],
    ...                headers="firstrow", theme="mediawiki"))
    {| class="wikitable" style="text-align: left;"
    |+ <!-- caption -->
    |-
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="latex"))
    \\begin{tabular}{lr}
    \\hline
     spam &  41.9999 \\\\
     eggs & 451      \\\\
    ...
    >>> echo(tabular([["spam$_9$", 41.9999], ["\\\\emph{eggs}", "451.0"]], theme="latex_raw"))
    \\begin{tabular}{lr}
    \\hline
     spam$_9$    &  41.9999 \\\\
     \\emph{eggs} & 451      \\\\
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="latex_booktabs"))
    \\begin{tabular}{lr}
    \\toprule
     spam &  41.9999 \\\\
     eggs & 451      \\\\
    ...
    >>> echo(tabular([["spam", 41.9999], ["eggs", "451.0"]], theme="latex_longtable"))
    \\begin{longtable}{lr}
    \\hline
     spam &  41.9999 \\\\
     eggs & 451      \\\\
    ...
    to reasonably be too long to look good as a single line, tabular can help automate
    ...
    if (
        not isinstance(theme, TableFormat)
        and theme in multiline_formats
        and _is_multiline(plain_text)
    ):
        theme = multiline_formats.get(theme, theme)
        is_multiline = True
    else:
        is_multiline = False
    ...
    if not isinstance(theme, TableFormat):
        theme = _table_formats.get(theme, _table_formats["simple"])
