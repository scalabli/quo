...
"""
edx-sphinx-theme documentation build configuration file.
...
#
# html_title = 'edx-sphinx-theme v1.0'
...
htmlhelp_basename = 'edx-sphinx-themedoc'
...
man_pages = [
    (master_doc, 'edx-sphinx-theme', 'edx-sphinx-theme Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'edx-sphinx-theme', 'edx-sphinx-theme Documentation',
     author, 'edx-sphinx-theme', 'A Sphinx theme for Open edX documentation',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_theme')])
