...
def test_no_wrap_no_crop():
    ...
    console.echo(test, no_wrap=True)
    console.echo(test, no_wrap=True, crop=False, overflow="ignore")
...
def test_print_sep_end(print_text, result):
    ...
    console.echo(*print_text, sep="", end="X")
